...
(function() {
  ...
  SubmarineCable.Map = (function() {
    class Map {
      ...
      selectCable(id, desc, data, is_map_clicked = false) {
        console.log(data);
        this.infoBox.close();
        ...
        const anArr = data.landing_points[0].latlon.split(",");
        this.infoBox.close();
        this.infoBox.open(this.gmap);
        this.infoBox.setPosition(new google.maps.LatLng(anArr[0], anArr[1]));
        // this.gmap.panTo(new google.maps.LatLng(anArr[0], anArr[1]));
        // this.gmap.panTo(bla);
        // debugger;
        var infoid = data.id;
        this.infoBox.setContent(`<div class="infoBoxContent-cables" id="${
          data.id
          }"> 
        <span class="cross-btn" onClick="hideInfoBox('${infoid}')"><img src="assets/images/cross-icon.png" alt="X"></span>
          <div class="infoBoxPointer"></div>
            <b> Name:</b> ${data.name} <br>
            <b> Id: </b> ${data.id} <br>
            <b> Length: </b> ${data.length} <br> 
            <b> Rfs: </b>${data.rfs} <br>  
            <b> Owners: </b> ${data.owners}  
          </div>
        </div>`);
    ...
    Map.cablesGeoJSON = "/api/v2/cable/omantel-cables.json";
    Map.landingsGeoJSON = "/api/v2/landing-point/omantel-landing-points.json";
